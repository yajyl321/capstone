<x-advance-layout :title="'Login'">
    ...
    <div class="py-44" style="height: 100vh; background: url('{{ asset('teachers.jpg') }}') no-repeat center center/cover; z-index: -1;">
        <div class="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#ffffff] rounded-2xl shadow-xl">
            ...
            <form class="flex flex-col" action="{{ route('teacher.login') }}" method="POST">
                @csrf
                <div class="pb-2">
                ...
                <div class="text-sm font-light text-[#6B7280] ">Don't have an accout yet? <a href="{{ route('teacher.register')}} " class="font-medium text-[#4F46E5] hover:underline">Sign Up</a>
